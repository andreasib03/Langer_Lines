...
class AnalysisPersistenceHelper @Inject constructor(
    ...
    suspend fun save(
        ...
        Log.d(TAG, "Analisi salvata: date=$date path=$uri lines=${lines.size}")
        uri.toString()
    }
    ...
    private fun buildResultSummary(lines: List<LangerLine>, bodyPartId: String): String {
    ...
    companion object {
        private const val TAG = "AnalysisPersistence"
    }
}